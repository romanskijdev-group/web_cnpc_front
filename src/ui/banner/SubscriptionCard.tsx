...
export const SubscriptionCard: React.FC<SubscriptionCardProps> = ({
    ...
    return (
        <div className="relative flex flex-col justify-between dark:bg-[#1B1C22] rounded-lg shadow-md p-6 text-left hover:translate-y-[-7px] transition-transform duration-300">
            <div>
                ...
                <ul className="list-none pl-6 mb-6">
                    {Array.isArray(body) ? (
                        body.map((item, index) => (
                            <li key={index} className="relative mb-4 pl-10 text-gray-300">
