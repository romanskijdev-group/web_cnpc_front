        ...
        <div className='transition-all duration-300 sm:max-w-screen-xl w-[90%] mx-auto mt-[150px] rounded-lg p-4'
            ...
            <div className='flex flex-col gap-0'>
                <ContactItem
                    ...
                    body={
                        <div>
                            <p className='mb-2'>Мы рады, что вам понравился наш веб-сайт! Наша платформа создана для того, чтобы объединить творческих людей, которые хотят создавать уникальные квест-линейки для CustomNPC в Minecraft. <br />Мы стремимся сделать процесс создания квестов увлекательным и доступным для всех! Если у вас есть вопросы или предложения, не стесняйтесь обращаться к нам. Ваше мнение важно для нас, и мы всегда готовы улучшать наш продукт для вас!</p>
                        </div>
                    }
                    mail={true}/>
                <ContactItem
