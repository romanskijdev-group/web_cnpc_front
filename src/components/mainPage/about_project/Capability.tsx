...
export const Capability: FC = () => {
    ...
    return(
        <div className='sm:max-w-screen-xl w-[90%] mx-auto mt-[150px] rounded-lg p-4'
             id='capabilities' data-aos='fade-up'>
            <h1 className='dark:text-gray-200 text-center py-5 text-xl sm:text-3xl'>{t('capability.title')}</h1>
